...
// ============================================================
// Modded SCR_PlayerController - adds range tools RPCs
// Inherits replication from SCR_PlayerController so
// RplRcver.Owner routes correctly to the owning client.
// ============================================================
